<?php
// MODIFIED BY HENRIQUE VICENTE
// TO WORK WITH XHTML 1.0 STRICT
// BEAWARE, HOWEVER, THAT THE DOC STILL HAS TO BE SENT AS text/html
// ALSO, NOTICE THE XHTML = true
/**
 * Zend Framework
 *
 * LICENSE
...
HTML;*/
        ...
        $return .= <<<HTML
<noscript><div id="challenge">
   <object data="{$host}/noscript?k={$this->_publicKey}{$errorPart}"
       type="text/html" height="300" width="500"></object>
   <textarea name="recaptcha_challenge_field" rows="3" cols="40">
   </textarea>
   <input type="hidden" name="recaptcha_response_field"
       value="manual_challenge"{$htmlInputClosing}
