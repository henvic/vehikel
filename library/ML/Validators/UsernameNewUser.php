...
class MLValidator_UsernameNewUser extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::MSG_USERNAME_RESERVED => "This username is reserved and can not be registered",
        self::MSG_USERNAME_INVALID => "This username is invalid. You can only use a-z, 0-9, _ and - for your username",
