...
{	
    public function init()
    {
        ...
        $this->addElement('hash', 'no_csrf_foo', array('salt' => '*UFEWWFfj0ic4w98j', 'timeout' => 6000));
        ...
        $this->getElement("tos")->setErrorMessages(array("You can only sign up to Plifk if you accept the Terms of Service"));
    }
}