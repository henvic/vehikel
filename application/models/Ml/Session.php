...
class Ml_Model_Session
{
    ...
    protected $_dbTableName = "user_sessions_lookup";
     ...
     * @return void
     */
    public final function __construct(Zend_Auth $auth, Zend_Cache_Core $cache, $dbConfig = array())
    {
        $this->_cache = $cache;
        $this->_auth = $auth;
        ...
        $this->_dbTable = new Ml_Model_Db_Table($this->_dbTableName, "id", $dbConfig);
    ...
    {
        $sessionsList = $this->listRecentSessionsMeta($this->_auth->getIdentity());
