...
class UserPostManagerController extends Ml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $form = new Ml_Form_UserPostEdit(null, $this->_translatePosts, $availableEquipment, $params["username"], $params["post_id"], $type);
        ...
        if ($this->getRequest()->isPost()) {
            $formKeys = array("make", "model", "name", "price", "model_year", "engine", "traction",
                "transmission", "fuel", "km", "armor", "handicapped", "equipment", "description", "status");
